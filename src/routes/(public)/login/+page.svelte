...
<section class="wave-red h-fit min-h-screen flex items-center justify-center w-full" data-theme="custom">
    <div class="w-full min-w-fit max-w-xl blur-bg bg-[#ffffff91] h-fit flex items-center flex-col space-y-10 my-32 mx-5 pt-10 pb-5 custom-box-shadow rounded-xl">
        ...
        <div class="btn-group sunsetFire scrollable solid flex-none">
            <button class="btn solid sunsetFire">
        ...
        <span class="flex flex-col space-y-7 px-5 mt-10 w-full">
            ...
            <div class="input info solid">
                ...
                <div class="is-divider" style="background-color: #FA7268;" />
                <input type="password" style="color: #FA7268;" />
                <svg
                    width="15"
                    height="15"
                    viewBox="0 0 15 15"
            ...
            <button class="btn sunsetFire solid ml-auto" on:click={()=>{goto('main')}}>Login</button>
        </span>
    </div>
</section>
