...
<section class="w-full dusk-waves-inverse h-screen flex justify-center items-center select-none">
    <div class="text-lg mx-auto text-center p-3 flex flex-col justify-center items-center space-y-4">
        ...
        <div class="flex justify-between w-80 sm:w-96">
            ...
            <span>
                <button class="btn orangeWeb solid" on:click={()=>{displayCardsForThreeSeconds()}}> 
...
<div>
    ...
    <div class="modal {showEndModal ? 'show' : ''} flex flex-col bg-platinum-400 gap-5 w-full max-w-sm">
